...
public class Constant {
    ...
    public static final String EXTENSION_FIELD_19 = "19";//分享短视频
    ...
    public static final String EXTENSION_FIELD_33 = "33";//转赠代付提醒
    public static final String EXTENSION_FIELD_34 = "34";//文交所 转赠代付提醒.
    public static final String EXTENSION_FIELD_35 = "35";//邀请聊主
    ...
    public static final String ANNOUNCEMENT_TO_INFORM = "ANNOUNCEMENT_TO_INFORM";//公告消息未读消息数量
    public static final String ANNOUNCEMENT_TO_INFORM_String = "ANNOUNCEMENT_TO_INFORM_String";//公告消息未条
    public static final String HTTP_ONE_HONE_ISFIRST = "HTTP_ONE_HONE_ISFIRST";//存储是否第一次加载首页
