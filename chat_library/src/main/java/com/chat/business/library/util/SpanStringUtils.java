...
//		String regexEmotion = "\\[([\u4e00-\u9fa5\\w])+\\]";
        ...
        while (matcherEmotion.find()) {
            ...
            if (imgRes != null) {
                ...
                LogUtils.d("SpanStringUtils", "imgRes:" + imgRes);
...
//		String regexEmotion = "\\[([\u4e00-\u9fa5\\w])+\\]";
        ...
        while (matcherEmotion.find()) {
            ...
            if (imgRes != null && imgRes > 0) {
                LogUtils.d("SpanStringUtils", "key" + key);
                // 压缩表情图片
                String[] des = key.split(":");
                LogUtils.d("SpanStringUtils", "des[0].length():" + des[0].length()+"----des[0]--->"+des[0]+"---des[0]---"+des[1]);
                int size;
                if(des[0].length() > 3){
