...
import com.chat.business.library.emotionkeyboardview.EmojiIndicatorView;
import com.chat.business.library.util.DisplayUtils;
 ...
 */
public class EmotiomComplateFragment extends BasisFragment {
    ...
    private GridView createEmotionGridView(List<String> emotionNames, int gvWidth, int padding, int itemWidth, int gvHeight) {
        ...
        // 给GridView设置表情图片
        EmotionGridViewAdapter adapter = new EmotionGridViewAdapter(getActivity(), emotionNames, itemWidth, emotion_map_type, classic_extended);
        gv.setAdapter(adapter);
        //设置全局点击事件
        gv.setOnItemClickListener(GlobalOnItemClickManagerUtils.getInstance(getActivity()).getOnItemClickListener(emotion_map_type, classic_extended));
        return gv;
    }
