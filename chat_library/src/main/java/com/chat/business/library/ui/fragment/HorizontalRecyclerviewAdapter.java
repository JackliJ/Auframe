...
import com.chat.business.library.util.ScreenUtils;
...
public class HorizontalRecyclerviewAdapter extends RecyclerView.Adapter<HorizontalRecyclerviewAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view =mInflater.inflate(R.layout.row_recyclerview_horizontal_item, parent, false);
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        if(model.isSelected){
            holder.imageBtn.setBackgroundColor(context.getResources().getColor(R.color.d1));
        }else {
            holder.imageBtn.setBackgroundColor(Color.parseColor("#eeeeee"));
        }
