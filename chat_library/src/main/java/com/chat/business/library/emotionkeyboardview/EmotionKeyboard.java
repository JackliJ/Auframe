package com.chat.business.library.emotionkeyboardview;
...
public class EmotionKeyboard {
    ...
    public boolean interceptBackPress() {
        LogUtils.d("EmotionKeyboard", "mEmotionLayout.isShown():" + mEmotionLayout.isShown());
        if (mEmotionLayout.isShown()) {
//            hideEmotionLayout(false);
    ...
    private int getSupportSoftInputHeight() {
        ...
        if (softInputHeight < 0) {
            LogUtils.d("EmotionKeyboard", "EmotionKeyboard--Warning: value of softInputHeight is below zero!");
        }
        //存一份到本地
        if (softInputHeight > 0) {
