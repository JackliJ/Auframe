package com.android.maiguo.activity.aliyun.seekbar;
...
public class IndicatorSeekBar extends View
     ...
     *
     * @param progress a new progress value , if the new progress is less than min , it will set to min ,if over max
     *                 ,will be max.
     */
     ...
     *
     * @param customIndicatorView the view is the indicator you touch to show;
     * @param progressTextViewId  the progress id in the indicator root view , this id view must be a textView to show
     *                            the progress
     */
    ...
    public interface OnSeekBarChangeListener {
         ...
         * @param progress      The current progress level. This will be in the range 0..max where max was set by
         *                      default. (The default value for max is 100.)
         * @param progressFloat The current progress level. This will be in the range 0.0f.max where max was set by
         *                      default. (The default value for max is 100.0f.)
        ...
        /**
         * this callback only effect on discrete serious seek bar type ; when the thumb location change on tick ,will
         * call this.
         *
         * @param seekBar        The SeekBar whose progress has changed
         * @param thumbPosOnTick The thumb's position on the seek bar's tick,if seek bar type is DISCRETE serious, min
         *                       thumbPosition is 0 , max is ticks length - 1 ; if seek bar type is CONTINUOUS serious,
         ...
         */
        void onSectionChanged(IndicatorSeekBar seekBar, int thumbPosOnTick, String textBelowTick,
    ...
    public static class Builder {
        ...
        /**
         * call this method to change the block size of seek bar, when seek bar type is continuous series will be not
         * worked.
         *
         * @param tickNum the tick count show on seek bar. if you want seek bar block size is N , this tickNum should be
         *                N+1.
         * @return Builder
         */
        ...
        /**
         * set the seek bar's tick width , if tick type is rec, call this method will be not worked(tick type is rec,has
         * a regular value 2dp).
         *
         ...
         *
         * @param tickType TickType.REC; TickType.OVAL; TickType.NONE;
         * @return Builder
         */
         ...
         *
         * @param seekBarType IndicatorSeekBarType.CONTINUOUS; IndicatorSeekBarType.CONTINUOUS_TEXTS_ENDS;
         *                    IndicatorSeekBarType.DISCRETE; IndicatorSeekBarType.DISCRETE_TICKS;
         *                    IndicatorSeekBarType.DISCRETE_TICKS_TEXTS; IndicatorSeekBarType.DISCRETE_TICKS_TEXTS_ENDS;
         * @return Builder
         */
         ...
         *
         * @param indicatorType IndicatorType.SQUARE_CORNERS; IndicatorType.ROUNDED_CORNERS; IndicatorType.CUSTOM;
         * @return Builder
         */
        ...
        /**
         * call this method to show the text below thumb ,the text will slide with the thumb. have no influence on
         * discrete series seek bar type.
         *
        ...
        /**
         * replace the left ends text of seek bar. leftEndText the text below SeekBar's left end below
         *
