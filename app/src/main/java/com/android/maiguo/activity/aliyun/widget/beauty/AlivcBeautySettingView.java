package com.android.maiguo.activity.aliyun.widget.beauty;
...
public class AlivcBeautySettingView extends FrameLayout {
    ...
    public void bottomTabChange(int tabIndex) {
        Drawable arrowdrawable = ContextCompat.getDrawable(mContext, R.mipmap.alivc_beauty_level_tab_checked);
