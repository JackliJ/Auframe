...
import com.smallvideo.maiguo.aliyun.view.effects.filter.SpaceItemDecoration;
...
public class ColorFilterChooserView extends BaseChooser implements OnItemClickListener {
    ...
    public boolean onItemClick(EffectInfo effectInfo, int index) {
        EventBus.getDefault().post((new SelectColorFilter.Builder()
    ...
    protected void init() {
        ...
        mTvEffectTitle.setText(R.string.video_filter_face);
